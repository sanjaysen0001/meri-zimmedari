...
//   }
  ...
  <div>
  Please enter the password linked with mobile number 9654458767.
  </div>
  ...
  <fieldset  style={{color:'rgb(82, 114, 161)', fontSize:'20px',fontFamily:'Calibri', border: "1px solid rgb(114, 158, 216)",borderRadius:'10px',height:'4rem',width:'100%'}}>
     <legend style={{color:'rgb(82, 114, 161)',marginBottom:'-5px', fontSize:'16px',paddingLeft:'5px',fontFamily:'Calibri',marginLeft:'15px',width:'7.5rem'}} for="exampleInputPassword1" class="form-label">Enter Password 
     
     </legend>
    
   <input style={{border:"none",outline: "none",width:"100%" ,paddingLeft:'15px',paddingTop:'3px'}} max={6}  type="tel" id="mobile" name="mobile" pattern="[0-9]{10}"  required />
         ...
         <span className='ml-1'>
         <Link to={'/Forgot/password/otp'} style={{textDecoration:'none'}}>Forgot Password</Link>
         </span>
         </div>
  <div className="mt-3">
   
  <button  type="button" class="btn " style={{width:"100%", backgroundColor:"#4478c7" , color:"white",height:'2.8rem'}}> Sign In </button>
