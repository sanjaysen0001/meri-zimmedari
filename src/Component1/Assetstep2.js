 ...
 */}
 ...
 <div style={{borderBottomLeftRadius:" 50px" ,borderBottomRightRadius:" 50px" , backgroundColor:'rgb(92, 139, 201)',textAlign:'center'}}>
 
<span style={{color:'white',fontSize:'20px',fontFamily:'Calibri'}}>
Auto-fill from pre-saved nominees
</span>  <br></br>
<span >
<svg xmlns="http://www.w3.org/2000/svg" color='white'  width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill" viewBox="0 0 16 16">
 ...
 <div className='col-md-2 col-sm-2 col-lg-2 col-xl-2'></div>
  ...
  <button  className='ml-2 btn' style={{border:'none', backgroundColor:'rgb(182, 205, 236)' , width:'7rem', borderRadius:'5px',lineHeight:'15px'}}>
  Add More Nominee

  </button>
  <Link to={'/add-asset/step3'}>
  <button className='ml-2' style={{border:'none', backgroundColor:'rgb(182, 205, 236)' , padding:'8px', width:'7rem', borderRadius:'5px'}}>
  Next
  </button>
  </Link>
  </div>
